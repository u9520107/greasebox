...
var removeImports = require(path.resolve(__dirname, '../source/remove-imports'));
...
describe('removeImports', function() {
  it('should be a function', function() {
    expect(removeImports).to.be.a('function');
  });

  it('should return an writable object', function() {
    let obj = removeImports();
